...
/**
 * This is a simple program that plays Rock, Paper, Scissors, Lizard, Spock with the user
 *
 * @author Bill Mullen
 * @version 2/11/2020
 */
public class RPSLSpock {
    ...
    /**
     * Validates that the input is a valid pick of either rock, paper, scissors, lizard, or Spock
     *
     * @param pick the input to be validated
     * @return boolean value, true for a valid pick, false otherwise
     */
    ...
    /**
     * Randomly generates the computer's pick of either rock, paper, scissors, lizard, or Spock
     *
     * @return a String representing the computer's pick
     */
    ...
    /**
     * Determines whether the computer wins or loses
     *
     * @param c_pick the computer's pick
     * @param h_pick the user's pick
     * @return boolean value, true if the computer wins, false if the computer loses
     */
